...
describe('convertClassName', () => {
	...
	it('result', () => {
		expect(convertClassName('xs', 'xs', className)).toEqual('col-xs-6 col-xs-offset-3 visible-xs-block visible-md-block something other');
		expect(convertClassName('sm', 'sm', className)).toEqual('col-xs-6 col-xs-offset-3 visible-sm-block visible-md-block something other');
		expect(convertClassName('md', 'md', className)).toEqual('col-xs-5 col-xs-push-3 col-xs-offset-2 visible-md-block visible-xs-block something other');
		expect(convertClassName('lg', 'lg', className)).toEqual('col-xs-5 col-xs-push-3 col-xs-offset-2 visible-lg-block visible-xs-block something other');
		expect(convertClassName('xs', 'md', className)).toEqual('col-xs-6 col-xs-offset-3 visible-md-block visible-lg-block something other');
		expect(convertClassName('xs', 'lg', className)).toEqual('col-xs-6 col-xs-offset-3 visible-lg-block visible-md-block something other');
	});
});
